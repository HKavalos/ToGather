...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_3.clicked.connect(self.clicked2)
    ...
    def clicked(self):
        ...
        frames.setupUi(app)
        self.options.append(app)
        self.scrollAreaWidgetContents.layout().addWidget(self.options[len(self.options)-1])
    def clicked2(self):
        self.options[len(self.options)-1].deleteLater()
        self.options.pop()
